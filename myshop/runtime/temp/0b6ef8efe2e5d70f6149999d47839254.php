<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"E:\phpStudy\WWW\1511phpM\myshop\public/../application/admin\view\role\set_node.html";i:1526534450;s:71:"E:\phpStudy\WWW\1511phpM\myshop\application\admin\view\public\base.html";i:1526642969;}*/ ?>
...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="row">
            ...
            <div class="col-xs-12">
 <form class="form-horizontal" role="form" method='post' action="<?php echo url('role/setNode'); ?>" >
                <!-- <form class="form-horizontal" role="form" method='post' action="<?php echo url('role/setNode'); ?>"> -->
                <input type="hidden" name="id" value="<?php echo input('id') ?>"  />
<?php foreach($node_tree as $val):?>
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">

  <input type="checkbox" name="node_id[]" value="<?=$val['id']?>"<?= isset($role_node[$val['id']]) ? 'checked' : ''; ?>/><?=$val['node_name']?></label>
<?php foreach($val['child'] as $v):?>
                        <div class="col-sm-9">
                            <input type="checkbox" name='node_id[]' value="<?=$v['id']?>" <?= isset($role_node[$v['id']]) ? 'checked' : ''; ?> /> <?=$v['node_name']?>
                        </div>
                         <?php endforeach; ?>
                    </div>
  <?php endforeach; ?>
