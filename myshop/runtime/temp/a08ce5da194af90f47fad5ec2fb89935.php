<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"E:\phpStudy\WWW\1511phpM\myshop\public/../application/admin\view\attr\update.html";i:1526607051;s:71:"E:\phpStudy\WWW\1511phpM\myshop\application\admin\view\public\base.html";i:1526527788;}*/ ?>
    ...
    <div class="page-content">
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" method='post' action="<?php echo url('attr/save'); ?>" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="text" name='attr_name' value="<?php echo $data['attr_name'] ?>" id="form-field-1" placeholder="属性名称" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                   ...
                   <!--  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name='input_mode' value="<?php echo $data['input_mode'] ?>" id="form-field-2" placeholder="模式" class="col-xs-10 col-sm-5" />
                        </div>
                    </div> <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 参数 </label>

                        <div class="col-sm-9">
                            <input type="text" name='param' value="<?php echo $data['param'] ?>" id="form-field-2" placeholder="参数" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name='value' value="<?php echo $data['value'] ?>" id="form-field-2" placeholder="规格" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name='def_value' value="<?php echo $data['def_value'] ?>" id="form-field-2" placeholder="缺省值" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
