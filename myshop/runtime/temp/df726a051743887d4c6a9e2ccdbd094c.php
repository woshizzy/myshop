<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"E:\phpStudy\WWW\1511phpM\myshop\public/../application/admin\view\good\show.html";i:1526608489;s:71:"E:\phpStudy\WWW\1511phpM\myshop\application\admin\view\public\base.html";i:1526610685;}*/ ?>
                                                ...
                                                <?php if(is_array($arr) || $arr instanceof \think\Collection || $arr instanceof \think\Paginator): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                    <tr>
                                                        ...
                                                        <td><img src="/<?php echo $vo['file']; ?>" alt="" width="100px" /></td>
                                                         ...
                                                         <td><a href="update?id=<?php echo $vo['goods_id']; ?>">修改</a>||<a href="delete?id=<?php echo $vo['goods_id']; ?>">删除</a>
                                                        </td>
