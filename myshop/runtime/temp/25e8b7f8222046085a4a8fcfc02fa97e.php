<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"E:\phpStudy\WWW\1511phpM\myshop\public/../application/admin\view\brand\showbrand.html";i:1526433686;s:71:"E:\phpStudy\WWW\1511phpM\myshop\application\admin\view\public\base.html";i:1526610685;}*/ ?>
                                            ...
                                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                ...
                                                <?php if(is_array($arr) || $arr instanceof \think\Collection || $arr instanceof \think\Paginator): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                    <tr>
                                                        ...
                                                        <td><img src="/<?php echo $vo['file']; ?>" alt="" width="100px" /></td>
                                                         <td><?php echo $vo['sort']; ?></td>
                                                        <td>
                                                        <!-- <button class="btn">编辑</button> -->
                                                         <a href="update?id=<?php echo $vo['brand_id']; ?>">修改</a>||<a href="delete?id=<?php echo $vo['brand_id']; ?>">删除</a>
                                                        </td>
