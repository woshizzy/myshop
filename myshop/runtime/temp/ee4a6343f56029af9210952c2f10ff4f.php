<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"E:\phpStudy\WWW\1511phpM\myshop\public/../application/admin\view\cate\index.html";i:1526435579;s:71:"E:\phpStudy\WWW\1511phpM\myshop\application\admin\view\public\base.html";i:1526610685;}*/ ?>
...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" method='post' action="<?php echo url('cate/insert'); ?>" enctype="multipart/form-data">
 ...
 -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name='sort' id="form-field-2" placeholder="排序" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name='pid' id="form-field-2" placeholder="父级id" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
