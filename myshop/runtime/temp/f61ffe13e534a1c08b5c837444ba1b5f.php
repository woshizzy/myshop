<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"E:\phpStudy\WWW\1511phpM\myshop\public/../application/admin\view\brand\update.html";i:1526434609;s:71:"E:\phpStudy\WWW\1511phpM\myshop\application\admin\view\public\base.html";i:1526610685;}*/ ?>
    ...
    <div class="page-content">
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" method='post' action="<?php echo url('brand/save'); ?>" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="text" name='brand_name' value="<?php echo $res['brand_name'] ?>" id="form-field-1" placeholder="品牌名称" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <img src="/<?php echo $res['file'] ?>" alt="" width="100px" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name='sort' value="<?php echo $res['sort'] ?>" id="form-field-2" placeholder="排序" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
