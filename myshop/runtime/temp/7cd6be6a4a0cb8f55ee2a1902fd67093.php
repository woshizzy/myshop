<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"E:\phpStudy\WWW\1511phpM\myshop\public/../application/admin\view\gtype\index.html";i:1526612880;s:71:"E:\phpStudy\WWW\1511phpM\myshop\application\admin\view\public\base.html";i:1526610685;}*/ ?>
    ...
    <div class="page-content">
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" method='post' action="<?php echo url('gtype/insert'); ?>" enctype="multipart/form-data">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 类型名称 </label>

                        <div class="col-sm-9">
                            <input type="text" name='type_name' id="form-field-1" placeholder="商品名称" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
