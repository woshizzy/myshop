<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"E:\phpStudy\WWW\1511phpM\myshop\public/../application/admin\view\attr\show.html";i:1526606861;s:71:"E:\phpStudy\WWW\1511phpM\myshop\application\admin\view\public\base.html";i:1526642969;}*/ ?>
...
<style>
    ...
    <a href="<?php echo url('brand/index'); ?>">添加</a>
                            <div class="row">
                                            ...
                                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                ...
                                                <?php if(is_array($arr) || $arr instanceof \think\Collection || $arr instanceof \think\Paginator): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $vo['input_mode']; ?></td>

                                                        <td><?php echo $vo['param']; ?></td>
                                                        <td><?php echo $vo['value']; ?></td>
                                                         <td><?php echo $vo['def_value']; ?></td>
                                                        <td>
                                                        <!-- <button class="btn">编辑</button> -->
                                                         <a href="update?id=<?php echo $vo['attr_id']; ?>">修改</a>||<a href="delete?id=<?php echo $vo['attr_id']; ?>">删除</a>
                                                        </td>
