<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"E:\phpStudy\WWW\1511phpM\myshop\public/../application/admin\view\user\index.html";i:1526296917;s:71:"E:\phpStudy\WWW\1511phpM\myshop\application\admin\view\public\base.html";i:1526527788;}*/ ?>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="table-responsive">
                    <a class="btn btn-bottom" href="<?= url('add')?>">添加用户</a>
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $val['id'];?></td>
                                <td><?= $val['username'];?></td>
                                <td><?= UserModel::getStatus($val['status']);?></td>
                                <td>
                                    <button class="btn btn-link">编辑</button>
                                    <a class="btn btn-link" href='<?= url("user/delete", ["id" => $val["id"]])?>'>删除</a>
                                </td>
