<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"E:\phpStudy\WWW\1511phpM\myshop\public/../application/admin\view\cate\show.html";i:1526439070;s:71:"E:\phpStudy\WWW\1511phpM\myshop\application\admin\view\public\base.html";i:1526527788;}*/ ?>
...
<html lang="en">
    ...
    <a href="<?php echo url('cate/index'); ?>">添加</a>
                            <div class="row">
                                                ...
                                                <?php if(is_array($arr) || $arr instanceof \think\Collection || $arr instanceof \think\Paginator): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                    <tr>
                                                        ...
                                                        <button class="btn btn-danger">删除</button> -->
                                                         ...
                                                         <a href="update?id=<?php echo $vo['cate_id']; ?>">修改</a>||<a href="delete?id=<?php echo $vo['cate_id']; ?>">删除</a>
                                                        </td>
