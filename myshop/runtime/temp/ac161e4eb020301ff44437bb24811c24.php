<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"E:\phpStudy\WWW\1511phpM\myshop\public/../application/admin\view\gtype\update.html";i:1526612442;s:71:"E:\phpStudy\WWW\1511phpM\myshop\application\admin\view\public\base.html";i:1526610685;}*/ ?>
    ...
    <div class="page-content">
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" method='post' action="<?php echo url('gtype/save'); ?>" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="text" value="<?php echo $data['type_name'] ?>" name='type_name' id="form-field-1" placeholder="类型名称" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                         ...
                         <?php foreach($cate as $k =>$v ) : ?>
                               <option value="<?php echo $v['cate_name'] ?>"><?php echo $v['cate_name'] ?></option>
                                <?php foreach($v['child'] as $key =>$val ) : ?>
                                   <option value="<?php echo $val['cate_name'] ?>">  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $val['cate_name'] ?></option>
