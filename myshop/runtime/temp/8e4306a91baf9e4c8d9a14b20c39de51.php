<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"E:\phpStudy\WWW\1511phpM\myshop\public/../application/admin\view\good\index.html";i:1526611788;s:71:"E:\phpStudy\WWW\1511phpM\myshop\application\admin\view\public\base.html";i:1526610685;}*/ ?>
    ...
    <div class="page-content">
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" method='post' action="<?php echo url('good/insert'); ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                       ...
                       <!--  <div class="col-sm-9"> -->
                        <?php foreach($attr as $k =>$v ) : ?>
                            <input type="checkbox" name='attr_id[]' id="form-field-2" value="<?php echo $v['attr_id'] ?>" placeholder="商品属性" /><?php echo $v['attr_name'] ?><?php echo $v['value'] ?>
                        <!-- </div> -->
 <?php endforeach; ?>
                    </div>
 <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name='goods_price' id="form-field-1" placeholder="商品价格" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
<div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name='kucun' id="form-field-1" placeholder="库存" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
