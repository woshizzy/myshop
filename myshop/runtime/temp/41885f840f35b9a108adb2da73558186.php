<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"E:\phpStudy\WWW\1511phpM\myshop\public/../application/admin\view\user\add.html";i:1526284245;s:71:"E:\phpStudy\WWW\1511phpM\myshop\application\admin\view\public\base.html";i:1526527788;}*/ ?>
            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" method='post'>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name='username' id="form-field-1" placeholder="用户名" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="password" name='password' id="form-field-2" placeholder="密码" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
