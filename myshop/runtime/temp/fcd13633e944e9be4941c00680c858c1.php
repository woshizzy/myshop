<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"E:\phpStudy\WWW\1511phpM\myshop\public/../application/admin\view\attr\index.html";i:1526643584;s:71:"E:\phpStudy\WWW\1511phpM\myshop\application\admin\view\public\base.html";i:1526642969;}*/ ?>
            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" method='post' action="<?php echo url('attr/insert'); ?>" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name='attr_name' id="form-field-1" placeholder="属性名称" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
