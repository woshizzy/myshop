<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"E:\phpStudy\WWW\1511phpM\myshop\public/../application/admin\view\role\index.html";i:1526349385;s:71:"E:\phpStudy\WWW\1511phpM\myshop\application\admin\view\public\base.html";i:1526642969;}*/ ?>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="table-responsive">
                    <a class="btn btn-bottom" href="<?= url('add')?>">添加角色</a>
                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $val['role_name']?></td>
                                <td>
                                    <a href="<?= url('setNode', ['id' => $val['id']])?>">权限分配</a>
                                    <a href="<?= url('setUser', ['id' => $val['id']])?>">用户分配</a>
                                </td>
                                <td><?= RoleModel::getStatus($val['status'])?></td>
                                <td>
